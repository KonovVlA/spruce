 ...
 */
var RoundHandler = /** @class */ (function (_super) {
    __extends(RoundHandler, _super);
    function RoundHandler(interpreter) {
     ...
     */
    RoundHandler.prototype.handle = function (token, iContext) {
        try {
            return new InterpreterToken_1.InterpreterToken(TValues_1.TValues.NUMBER, NumberUtils_1.NumberUtils.round(this.getNumberArgumentValue(token, 0, iContext)));
        }
        catch (e) {
...
RoundHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.number.RoundHandler";
