 ...
 */
var ExpHandler = /** @class */ (function (_super) {
    __extends(ExpHandler, _super);
    function ExpHandler(interpreter) {
     ...
     */
    ExpHandler.prototype.handle = function (token, iContext) {
        try {
            return new InterpreterToken_1.InterpreterToken(TValues_1.TValues.NUMBER, NumberUtils_1.NumberUtils.exp(this.getNumberArgumentValue(token, 0, iContext)));
        }
        catch (e) {
...
ExpHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.number.ExpHandler";
