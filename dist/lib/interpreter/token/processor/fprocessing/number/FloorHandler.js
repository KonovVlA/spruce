 ...
 */
var FloorHandler = /** @class */ (function (_super) {
    __extends(FloorHandler, _super);
    function FloorHandler(interpreter) {
     ...
     */
    FloorHandler.prototype.handle = function (token, iContext) {
        try {
            return new InterpreterToken_1.InterpreterToken(TValues_1.TValues.NUMBER, NumberUtils_1.NumberUtils.floor(this.getNumberArgumentValue(token, 0, iContext)));
        }
        catch (e) {
...
exports.FloorHandler = FloorHandler;
FloorHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.number.FloorHandler";
