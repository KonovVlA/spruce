 ...
 */
var SqrtHandler = /** @class */ (function (_super) {
    __extends(SqrtHandler, _super);
    function SqrtHandler(interpreter) {
     ...
     */
    SqrtHandler.prototype.handle = function (token, iContext) {
        try {
            return new InterpreterToken_1.InterpreterToken(TValues_1.TValues.NUMBER, NumberUtils_1.NumberUtils.sqrt(this.getNumberArgumentValue(token, 0, iContext)));
        }
        catch (e) {
...
exports.SqrtHandler = SqrtHandler;
SqrtHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.number.SqrtHandler";
