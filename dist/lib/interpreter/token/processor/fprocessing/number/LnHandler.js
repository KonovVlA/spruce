 ...
 */
var LnHandler = /** @class */ (function (_super) {
    __extends(LnHandler, _super);
    function LnHandler(interpreter) {
     ...
     */
    LnHandler.prototype.handle = function (token, iContext) {
        try {
...
exports.LnHandler = LnHandler;
LnHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.number.LnHandler";
