 ...
 */
var AbsHandler = /** @class */ (function (_super) {
    __extends(AbsHandler, _super);
    function AbsHandler(interpreter) {
     ...
     */
    AbsHandler.prototype.handle = function (token, iContext) {
        try {
            return new InterpreterToken_1.InterpreterToken(TValues_1.TValues.NUMBER, /* abs */ this.getNumberArgumentValue(token, 0, iContext).abs());
        }
        catch (e) {
...
AbsHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.number.AbsHandler";
