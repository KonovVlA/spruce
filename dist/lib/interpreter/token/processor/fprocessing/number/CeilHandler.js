 ...
 */
var CeilHandler = /** @class */ (function (_super) {
    __extends(CeilHandler, _super);
    function CeilHandler(interpreter) {
     ...
     */
    CeilHandler.prototype.handle = function (token, iContext) {
        try {
            return new InterpreterToken_1.InterpreterToken(TValues_1.TValues.NUMBER, NumberUtils_1.NumberUtils.ceil(this.getNumberArgumentValue(token, 0, iContext)));
        }
        catch (e) {
...
exports.CeilHandler = CeilHandler;
CeilHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.number.CeilHandler";
