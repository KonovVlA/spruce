 ...
 */
export declare class MapHandler extends AbstractThreeArgAggregateHandler {
...
export declare namespace MapHandler {
     ...
     * @class
     */
    class MapHandleRunner extends AbstractThreeArgAggregateHandler.AbstractThreeArgAggregateHandleRunner {
        __parent: any;
