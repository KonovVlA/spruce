 ...
 */
export declare class FoldLeftHandler extends AbstractFoldHandler {
...
export declare namespace FoldLeftHandler {
    /**
     ...
     * @class
     */
    class FoldLeftHandleRunner extends AbstractFoldHandler.AbstractFoldHandleRunner {
        __parent: any;
