 ...
 */
export declare class FindHandler extends AbstractThreeArgAggregateHandler {
...
export declare namespace FindHandler {
    /**
     ...
     * @class
     */
    class FindHandleRunner extends AbstractThreeArgAggregateHandler.AbstractThreeArgAggregateHandleRunner {
        __parent: any;
