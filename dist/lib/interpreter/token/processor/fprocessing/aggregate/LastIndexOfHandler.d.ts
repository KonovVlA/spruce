 ...
 */
export declare class LastIndexOfHandler extends AbstractIndexOfHandler {
...
export declare namespace LastIndexOfHandler {
    /**
     ...
     * @class
     */
    class LastIndexOfHandleRunner extends AbstractIndexOfHandler.AbstractIndexOfHandleRunner {
        __parent: any;
