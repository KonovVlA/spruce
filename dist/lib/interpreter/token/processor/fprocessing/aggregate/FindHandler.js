 ...
 */
var FindHandler = /** @class */ (function (_super) {
    __extends(FindHandler, _super);
    function FindHandler(interpreter) {
     ...
     */
    FindHandler.prototype.getThreeArgAggregateHandleRunner = function (args, iContext) {
        return new FindHandler.FindHandleRunner(this, args, iContext);
    };
    /**
     ...
     */
    FindHandler.prototype.isReturnTypeLooksLikeBoolean = function (token) {
        this.validate(token);
        return true;
    };
    return FindHandler;
...
FindHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.aggregate.FindHandler";
(function (FindHandler) {
     ...
     * @class
     */
    var FindHandleRunner = /** @class */ (function (_super) {
        __extends(FindHandleRunner, _super);
        function FindHandleRunner(__parent, args, iContext) {
         ...
         */
        FindHandleRunner.prototype.getInitialValueOfResult = function () {
            return null;
        };
        /**
         ...
         */
        FindHandleRunner.prototype.runIteration = function (result, currentElement, i) {
            ...
            if (!StringUtils_1.StringUtils.areStringsEqual(currentConditionResult.t, TValues_1.TValues.BOOLEAN)) {
                throw new ComputingException_1.ComputingException("\u0420\u0435\u0437\u0443\u043b\u044c\u0442\u0430\u0442 \u0432\u044b\u0447\u0438\u0441\u043b\u0435\u043d\u0438\u044f \u0443\u0441\u043b\u043e\u0432\u0438\u044f \u0432 \u0444\u0443\u043d\u043a\u0446\u0438\u0438 \'" + FValues_1.FValues.FIND + "\' \u043d\u0430 \u0438\u0442\u0435\u0440\u0430\u0446\u0438\u0438 " + i + " \u0438\u043c\u0435\u0435\u0442 \u043d\u0435\u0432\u0435\u0440\u043d\u044b\u0439 \u0442\u0438\u043f (\u043e\u0436\u0438\u0434\u0430\u0435\u0442\u0441\u044f boolean, \u043f\u043e\u043b\u0443\u0447\u0435\u043d\u043e \'" + TValues_1.TValues.getTypeNameOrType(currentConditionResult.t) + "\').");
            }
            return currentConditionResult.v ? currentElement : null;
        };
        /**
         ...
         */
        FindHandleRunner.prototype.shouldContinueLoop = function (i, result) {
            return i < this.sz && result == null;
        };
        return FindHandleRunner;
    }(AbstractThreeArgAggregateHandler_1.AbstractThreeArgAggregateHandler.AbstractThreeArgAggregateHandleRunner));
    FindHandler.FindHandleRunner = FindHandleRunner;
    FindHandleRunner["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.aggregate.FindHandler.FindHandleRunner";
})(FindHandler = exports.FindHandler || (exports.FindHandler = {}));
exports.FindHandler = FindHandler;
