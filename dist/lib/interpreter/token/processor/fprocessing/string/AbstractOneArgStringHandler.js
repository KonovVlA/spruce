...
exports.AbstractOneArgStringHandler = void 0;
 ...
 * @class
 */
var AbstractOneArgStringHandler = /** @class */ (function (_super) {
    __extends(AbstractOneArgStringHandler, _super);
    function AbstractOneArgStringHandler(interpreter) {
     ...
     */
    AbstractOneArgStringHandler.prototype.validate = function (token) {
    ...
    return AbstractOneArgStringHandler;
}(AbstractStringHandler_1.AbstractStringHandler));
exports.AbstractOneArgStringHandler = AbstractOneArgStringHandler;
AbstractOneArgStringHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.fprocessing.string.AbstractOneArgStringHandler";
