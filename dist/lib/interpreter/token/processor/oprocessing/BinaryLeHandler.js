...
exports.BinaryLeHandler = void 0;
 ...
 * @class
 */
var BinaryLeHandler = /** @class */ (function (_super) {
    __extends(BinaryLeHandler, _super);
    function BinaryLeHandler(interpreter) {
        return _super.call(this, interpreter, OValues_1.OValues.B_LE) || this;
    }
    /**
     * Обрабатывает токен.
     *
     ...
     */
    BinaryLeHandler.prototype.handle = function (token, iContext) {
    ...
    return BinaryLeHandler;
}(AbstractRelativeComparisonOperationHandler_1.AbstractRelativeComparisonOperationHandler));
exports.BinaryLeHandler = BinaryLeHandler;
BinaryLeHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.oprocessing.BinaryLeHandler";
