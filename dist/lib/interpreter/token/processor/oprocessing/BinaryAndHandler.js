...
exports.BinaryAndHandler = void 0;
 ...
 * @class
 */
var BinaryAndHandler = /** @class */ (function (_super) {
    __extends(BinaryAndHandler, _super);
    function BinaryAndHandler(interpreter) {
        return _super.call(this, interpreter, OValues_1.OValues.B_AND) || this;
    }
    /**
     * Обрабатывает токен.
     *
     ...
     */
    BinaryAndHandler.prototype.handle = function (token, iContext) {
        var args = token.a;
    ...
    return BinaryAndHandler;
}(AbstractBinaryLogicOperationHandler_1.AbstractBinaryLogicOperationHandler));
exports.BinaryAndHandler = BinaryAndHandler;
BinaryAndHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.oprocessing.BinaryAndHandler";
