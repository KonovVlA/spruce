...
exports.BinaryGtHandler = void 0;
...
/**
 * Обработчик операции сравнения на больше.
 * @extends AbstractRelativeComparisonOperationHandler
 * @class
 */
var BinaryGtHandler = /** @class */ (function (_super) {
    __extends(BinaryGtHandler, _super);
    function BinaryGtHandler(interpreter) {
        return _super.call(this, interpreter, OValues_1.OValues.B_GT) || this;
    }
    /**
     * Обрабатывает токен.
     *
     ...
     */
    BinaryGtHandler.prototype.handle = function (token, iContext) {
    ...
    return BinaryGtHandler;
}(AbstractRelativeComparisonOperationHandler_1.AbstractRelativeComparisonOperationHandler));
exports.BinaryGtHandler = BinaryGtHandler;
BinaryGtHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.oprocessing.BinaryGtHandler";
