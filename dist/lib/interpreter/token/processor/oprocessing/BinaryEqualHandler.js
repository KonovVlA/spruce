...
exports.BinaryEqualHandler = void 0;
...
/**
 * Обработчик операции сравнения на равно.
 * @extends AbstractDirectComparisonOperationHandler
 * @class
 */
var BinaryEqualHandler = /** @class */ (function (_super) {
    __extends(BinaryEqualHandler, _super);
    function BinaryEqualHandler(interpreter) {
        return _super.call(this, interpreter, OValues_1.OValues.B_EQ) || this;
    }
    /**
     * Обрабатывает токен.
     *
     ...
     */
    BinaryEqualHandler.prototype.handle = function (token, iContext) {
    ...
    return BinaryEqualHandler;
}(AbstractDirectComparisonOperationHandler_1.AbstractDirectComparisonOperationHandler));
exports.BinaryEqualHandler = BinaryEqualHandler;
BinaryEqualHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.oprocessing.BinaryEqualHandler";
