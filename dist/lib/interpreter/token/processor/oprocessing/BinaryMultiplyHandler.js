...
exports.BinaryMultiplyHandler = void 0;
 ...
 * @class
 */
var BinaryMultiplyHandler = /** @class */ (function (_super) {
    __extends(BinaryMultiplyHandler, _super);
    function BinaryMultiplyHandler(interpreter) {
        return _super.call(this, interpreter, OValues_1.OValues.B_MUL) || this;
    }
    /**
     * Обрабатывает токен.
     *
     ...
     */
    BinaryMultiplyHandler.prototype.handle = function (token, iContext) {
        ...
        try {
            return new InterpreterToken_1.InterpreterToken(TValues_1.TValues.NUMBER, NumberUtils_1.NumberUtils.multiply(l1, r1));
        }
        catch (e) {
            throw new ComputingException_1.ComputingException("\u041d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u0432\u044b\u043f\u043e\u043b\u043d\u0438\u0442\u044c \u043e\u043f\u0435\u0440\u0430\u0446\u0438\u044e \'" + this.operationName + "\'.", e);
        }
    };
    return BinaryMultiplyHandler;
}(AbstractMultiplicativeOperationTokenHandler_1.AbstractMultiplicativeOperationTokenHandler));
exports.BinaryMultiplyHandler = BinaryMultiplyHandler;
BinaryMultiplyHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.oprocessing.BinaryMultiplyHandler";
