...
exports.BinaryOptionalAccessHandler = void 0;
 ...
 * @class
 */
var BinaryOptionalAccessHandler = /** @class */ (function (_super) {
    __extends(BinaryOptionalAccessHandler, _super);
    function BinaryOptionalAccessHandler(interpreter) {
        return _super.call(this, interpreter, OValues_1.OValues.B_OPTIONAL_ACCESS) || this;
    }
    /**
     * Обрабатывает токен.
     *
     ...
     */
    BinaryOptionalAccessHandler.prototype.handle = function (token, iContext) {
        var args = token.a;
        ...
        if (!StringUtils_1.StringUtils.areStringsEqual(objectToken.t, TValues_1.TValues.OBJECT)) {
            if (StringUtils_1.StringUtils.areStringsEqual(objectToken.t, TValues_1.TValues.NULL)) {
    ...
    return BinaryOptionalAccessHandler;
}(AbstractDotLikeAccessOperationHandler_1.AbstractDotLikeAccessOperationHandler));
exports.BinaryOptionalAccessHandler = BinaryOptionalAccessHandler;
BinaryOptionalAccessHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.oprocessing.BinaryOptionalAccessHandler";
