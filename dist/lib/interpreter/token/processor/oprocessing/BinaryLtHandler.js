...
exports.BinaryLtHandler = void 0;
...
/**
 * Обработчик операции сравнения на меньше.
 * @extends AbstractRelativeComparisonOperationHandler
 * @class
 */
var BinaryLtHandler = /** @class */ (function (_super) {
    __extends(BinaryLtHandler, _super);
    function BinaryLtHandler(interpreter) {
        return _super.call(this, interpreter, OValues_1.OValues.B_LT) || this;
    }
    /**
     * Обрабатывает токен.
     *
     ...
     */
    BinaryLtHandler.prototype.handle = function (token, iContext) {
    ...
    return BinaryLtHandler;
}(AbstractRelativeComparisonOperationHandler_1.AbstractRelativeComparisonOperationHandler));
exports.BinaryLtHandler = BinaryLtHandler;
BinaryLtHandler["__class"] = "ru.sbrf.ufs.prodsel.elengine.token.processor.oprocessing.BinaryLtHandler";
